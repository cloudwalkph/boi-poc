        ...
        <div class="col-md-12" style="z-index: 100; padding: 50px 80px;">
            <h2>Register</h2>
                <form class="" role="form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-group{{ $errors->has('profile.passport_number') ? ' has-error' : '' }}">
                            <label for="profile[passport_number]" class="control-label">Passport Number</label>
                            <input id="profile[passport_number]" type="text" class="form-control" name="profile[passport_number]" value="{{ old('profile.passport_number') }}" required>
                            @if ($errors->has('profile.passport_number'))
                                <span class="help-block">
                                <strong>{{ $errors->first('profile.passport_number') }}</strong>
                            </span>
                            @endif
                        </div>
                    </div>
