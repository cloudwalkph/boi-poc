		...
		<div class="row">
			<div id="extensionImg" style="display: flex;align-items: center;">
				...
				<div class="col-md-5 col-md-offset-1" style="z-index: 9999;color: #fff;">
					...
					<h5 style="color: #fff;"><strong>Online Application Form</strong></h5>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="container" style="padding-top: 30px;">
				...
				<p style="font-size: 20px"><strong>APPLICATION INFORMATION</strong></p>
			</div>
			<div class="container">
				<form>
					...
					<div class="row rowMargin">
						<div class="col-md-12">
							<p style="font-size: 20px"><strong>METHOD OF APPLICATION</strong></p>
						</div>
					</div>
					<div class="row rowMargin">
						<div class="col-md-3">
